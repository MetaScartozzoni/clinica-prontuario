...
const SelectTrigger = React.forwardRef(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-10 w-full items-center justify-between rounded-md border bg-[hsl(var(--input-bg-hsl))] px-3 py-2 text-sm ring-offset-background focus:outline-none focus:ring-2 focus:ring-[hsl(var(--ring-hsl))] focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50',
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        'bg-[hsl(var(--select-content-bg-hsl))] text-white border-violet-500',
        position === 'popper' &&
...
const SelectLabel = React.forwardRef(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn('py-1.5 pl-8 pr-2 text-sm font-semibold text-violet-200', className)}
    {...props}
  />
));
...
const SelectSeparator = React.forwardRef(({ className, ...props }, ref) => (
  <SelectPrimitive.Separator
    ref={ref}
    className={cn('-mx-1 my-1 h-px bg-violet-500/50', className)}
    {...props}
  />
));
